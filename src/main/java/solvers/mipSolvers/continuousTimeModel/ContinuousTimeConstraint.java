...
public class ContinuousTimeConstraint {

    public static void setConstraints(ProblemParameters parameters, GRBModel model, ContinuousTimeVariables variables) throws GRBException {
    ...
    private static void setEachCommercialAtMostOnce(ProblemParameters parameters, GRBModel model, ContinuousTimeVariables variables) throws GRBException {
    ...
    private static void setAtMostOneCommercialAtEachSpot(ProblemParameters parameters, GRBModel model, ContinuousTimeVariables variables) throws GRBException {
    ...
    private static void setOrdering(ProblemParameters parameters, GRBModel model, ContinuousTimeVariables variables) throws GRBException {
        for (Inventory inventory : parameters.getSetOfInventories()) {
    ...
    private static void setInventoryDuration(ProblemParameters parameters, GRBModel model, ContinuousTimeVariables variables) throws GRBException {
        for (Inventory inventory : parameters.getSetOfInventories()) {
            GRBLinExpr lhs = new GRBLinExpr();
            for (int n = 0; n < inventory.getMaxCommercialCount(); n++) {
                for (Commercial commercial : inventory.getSetOfSuitableCommercials()) {
    ...
    private static void setHourlyDurationLimit(ProblemParameters parameters, GRBModel model, ContinuousTimeVariables variables) throws GRBException {
    ...
    private static void setUnusedS0(ProblemParameters parameters, GRBModel model, ContinuousTimeVariables variables) throws GRBException {
        for (Commercial commercial : parameters.getSetOfCommercials()) {
            for (Inventory inventory : commercial.getSetOfSuitableInv()) {
                for (int n = 0; n < inventory.getMaxCommercialCount(); n++) {
                    GRBLinExpr lhs = new GRBLinExpr();
    ...
    private static void setSOLink(ProblemParameters parameters, GRBModel model, ContinuousTimeVariables variables) throws GRBException {
        for (Inventory inventory : parameters.getSetOfInventories()) {
            for (Commercial commercial : inventory.getSetOfSuitableCommercials()) {
                for (int n = 0; n < inventory.getMaxCommercialCount(); n++) {
    ...
    private static void setSZLink(ProblemParameters parameters, GRBModel model, ContinuousTimeVariables variables) throws GRBException {
        for (Inventory inventory : parameters.getSetOfInventories()) {
            for (Commercial commercial : inventory.getSetOfSuitableCommercials()) {
    ...
    private static void setZ1Link(ProblemParameters parameters, GRBModel model, ContinuousTimeVariables variables) throws GRBException {
        for (Commercial commercial : parameters.getSetOfCommercials()) {
            for (Inventory inventory : commercial.getSetOfSuitableInv()) {
                int t = 1;
    ...
    private static void setMustBeBroadcastedFirst(ProblemParameters parameters, GRBModel model, ContinuousTimeVariables variables) throws GRBException {
        for (Commercial commercial : parameters.getSetOfFirstCommercials()) {
            for (Inventory inventory : commercial.getSetOfSuitableInv()) {
                if (commercial.getAttentionMap().get(inventory) != ATTENTION.FIRST) continue;
    ...
    private static void setMustBeBroadcastedLast(ProblemParameters parameters, GRBModel model, ContinuousTimeVariables variables) throws GRBException {
    ...
    private static void setSubsequentCommercialConstraint(ProblemParameters parameters, GRBModel model, ContinuousTimeVariables variables) throws GRBException {
    ...
    private static void setF30(ProblemParameters parameters, GRBModel model, ContinuousTimeVariables variables) throws GRBException {
        for (Commercial commercial : parameters.getSetOfF30Commercials()){
            GRBLinExpr lhs = new GRBLinExpr();
            for (Inventory inventory : commercial.getSetOfSuitableInv()){
                if (commercial.getAttentionMap().get(inventory) != ATTENTION.F30) continue;
    ...
    private static void setF60(ProblemParameters parameters, GRBModel model, ContinuousTimeVariables variables) throws GRBException {
        for (Commercial commercial : parameters.getSetOfF60Commercials()){
            GRBLinExpr lhs = new GRBLinExpr();
            for (Inventory inventory : commercial.getSetOfSuitableInv()){
                if (commercial.getAttentionMap().get(inventory) != ATTENTION.F60) continue;
