...
import localSearch.move.IntraSwapMove;
...
public class IntraSwapSearch extends BaseSearch {
    ...
    public IntraSwapSearch(Solution currentSolution, ProblemParameters parameters, boolean getAllNeighborhood, boolean isBestMove, Random random) throws Exception {
